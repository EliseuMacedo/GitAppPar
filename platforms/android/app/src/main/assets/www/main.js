...
var map = {
	"./end-one/end-one.module": [
		"./src/app/end-one/end-one.module.ts",
		"end-one-end-one-module"
	],
	"./end-three/end-three.module": [
		"./src/app/end-three/end-three.module.ts",
		"end-three-end-three-module"
	],
	"./end-two/end-two.module": [
	...
	"./incompatible/incompatible.module": [
	...
	"./match-female/match-female.module": [
...
module.exports = __webpack_require__(/*! C:\Users\Ti05\Documents\workspace\glpvApp\appGlpv\src\main.ts */"./src/main.ts");
